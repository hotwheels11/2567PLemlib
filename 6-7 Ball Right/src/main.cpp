...
void autonomous() {
	...
	chassis.swingToHeading(60, lemlib::DriveSide::RIGHT,500,{.earlyExitRange=3});//Swing to first 3 blocks
	chassis.waitUntil(6);
	...
	chassis.moveToPoint(30.5,11,1000,{.maxSpeed=78}); //Drives infront of Matchload
	chassis.turnToHeading(178,500); //Turns to Matchloader
	chassis.moveToPoint(38,-10,1250,{.maxSpeed=50}); //Goes into Matchloader slowly
	chassis.moveToPoint(36,30,3500,{.forwards=false,.maxSpeed=40}); //Drives into long goal
	chassis.waitUntil(26);
	Hood.set_value(1);
	Matchload.set_value(0);
	chassis.waitUntilDone();
	chassis.moveToPoint(37,22,500);
	chassis.waitUntilDone();
	Hood.set_value(0);
	intake.move(0);
	chassis.turnToHeading(265,500);
	chassis.moveToPoint(30.7,15,500);
	chassis.turnToHeading(353,500);
	Descore.set_value(0);
	chassis.moveToPoint(21,43,2000,{.maxSpeed=50});
}
