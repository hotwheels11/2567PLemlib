...
inline pros::MotorGroup left_motors({10, -2, -12}, pros::MotorGearset::blue); // left motors on ports -9, -2, -12
inline pros::MotorGroup right_motors({-1, 6 , 13}, pros::MotorGearset::blue); // right motors on ports 7, 6, 13
inline pros::Imu imu(17);// imu on port 10

inline pros::Rotation horizontal_encoder(16);
inline pros::Rotation vertical_encoder(1);

inline pros::Motor intakeFront(-3);
